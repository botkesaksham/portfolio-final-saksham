...
export default function Experience() {
  return (
    <div id="experience" className="md:w-full ml-5 mr-5 p-4">
      ...
      <section
        className="my-20 flex w-full flex-col items-center justify-center gap-10 text-purple-500 overflow-hidden"
      >
